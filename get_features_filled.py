...
def main(args):
    ...
    for j, seq in enumerate(seqs):
        ...
        #path = f'{args.input_dir}/{seq}/filled_box_image.jpg'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", default='/ssd0/zihanwa3/data_ego/cmu_bike/ims', type=str, help="Directory with input sequences, ie, data/dataset/<sequences>/*.jpg.")
    parser.add_argument("--save_dir", default='/data3/zihanwa3/Capstone-DSR/Processing/dinov2features/', type=str, help="Directory to save features, ie, data/dataset_features/<sequences>/*.jpg.")
